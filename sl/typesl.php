<?php require_once('backend/cdb.php');
...
<div class="list-group">
    ...
    foreach ($result_type as $row) { ?>
        ...
        <a href="member.php?act=showbytype&type_id=<?php echo $row['type_id']; ?>" class="list-group-item list-group-item-action list-group-item-light">
